...
/**
 * Remove wp_robots() (wp_head priority 1) BEFORE wp_head fires for regular posts.
 * wp_robots outputs only: max-image-preview:large (incomplete).
 * pianomode_inject_seo_meta_tags() outputs the full: index, follow, max-snippet:-1, ...
 * Without this, both tags appear on every post page.
 */
