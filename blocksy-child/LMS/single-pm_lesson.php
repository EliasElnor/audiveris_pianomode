        ...
        <div class="pm-hearts-display">
            <?php for ($i = 0; $i < 5; $i++) : ?>
                <span class="pm-heart <?php echo $i >= $hearts ? 'pm-heart-empty' : ''; ?>">
                    <?php if ($i < $hearts) : ?>
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#D7BF81" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                    <?php else : ?>
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                    <?php endif; ?>
                </span>
            <?php endfor; ?>
