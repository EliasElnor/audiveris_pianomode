            ...
            .then(function (res) {
                if (res.success && res.data && res.data.country_code) {
                    ...
                    if (isLatin !== useLatinLabels) {
                        ...
                        // Update all piano labels
                        updateAllPianoLabels();
                        // Update lesson content note names
        ...
        fetch(ajaxUrl, { method: 'POST', body: fd })
            ...
            .then(function (res) {
                if (res.success && res.data && res.data.content) {
                    ...
                    bodyEl.innerHTML = '<p style="color:#808080;text-align:center;">Could not load article content. <a href="' + url + '" target="_blank" style="color:#D7BF81;">Open in new tab</a></p>';
                }
            })
            .catch(function () {
                bodyEl.innerHTML = '<p style="color:#808080;text-align:center;">Could not load article. <a href="' + url + '" target="_blank" style="color:#D7BF81;">Open in new tab</a></p>';
            });
    }
