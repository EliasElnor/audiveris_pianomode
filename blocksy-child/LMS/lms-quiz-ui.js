    ...
    window.PianoModeQuiz = {
        ...
        buildUI: function() {
            var html = '<div class="pm-quiz-overlay" id="pmQuizOverlay">' +
                ...
                '<div class="pm-quiz-complete" id="pmQuizComplete">' +
                    ...
                    '<div class="pm-quiz-stats-grid">' +
                        ...
                        '<div class="pm-quiz-stat"><div class="pm-quiz-stat-value" id="pmStatHearts">0</div><div class="pm-quiz-stat-label">Hearts</div></div>' +
                    '</div>' +
            ...
            '<div class="pm-hearts-modal" id="pmHeartsModal">' +
                '<div class="pm-hearts-modal-card">' +
                    ...
                    '<h3 class="pm-hearts-modal-title">You ran out of hearts!</h3>' +
                    '<p class="pm-hearts-modal-text">Refill your hearts with 50 XP to continue, or quit and practice later.</p>' +
                    '<div class="pm-hearts-modal-actions">' +
                        '<button class="pm-hearts-refill-btn" id="pmRefillHearts">Refill Hearts (50 XP)</button>' +
        ...
        renderHearts: function() {
            ...
            for (var i = 0; i < 5; i++) {
                ...
                html += '<span class="pm-quiz-heart' + cls + '">&#10084;&#65039;</span>';
            }
            return html;
        },
            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    if (resp.success) {
                        ...
                        alert('Not enough XP to refill hearts. You need 50 XP.');
                    }
                }
            };
