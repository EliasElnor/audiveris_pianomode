...
<!-- ═══════════════════════════════════════════════════════════════════
     SEARCH & FILTERS
     ═══════════════════════════════════════════════════════════════════ -->
<section class="pm-lp-search" id="pm-lp-search-section">
    <div class="pm-lp-search__inner">

        <!-- Animated title -->
        <div class="pm-lp-search__title-wrap">
            <span class="pm-lp-search__title-line"></span>
            <h2 class="pm-lp-search__title">
                Find Your Next <span class="pm-lp-search__title-gold">Score</span>
            </h2>
            <span class="pm-lp-search__title-line"></span>
        </div>

        <div class="pm-lp-search__row">
            <!-- Search Bar -->
            <div class="pm-lp-search__bar">
                <span class="pm-lp-search__icon-wrap">
                ...
                <input type="text" id="pm-lp-search" class="pm-lp-search__input" placeholder="Search scores, composers, styles..." aria-label="Search scores">
            </div>
            ...
            <!-- Clear + Count (inline) -->
            <div class="pm-lp-search__actions">
                <button type="button" id="pm-lp-clear" class="pm-lp-search__clear" aria-label="Clear all filters">
                ...
                <span id="pm-lp-count" class="pm-lp-search__count"></span>
            </div>
        </div>
    </div>
</section>
