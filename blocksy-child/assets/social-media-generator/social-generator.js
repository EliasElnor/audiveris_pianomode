...
(function () {
    ...
    var FORMATS = {
        instagram: { w: 1080, h: 1350, label: 'Instagram',  gradientStart: 0.52, titleSize: 54, descSize: 30, titleMaxW: 900, descMaxW: 880 },
        tiktok:    { w: 1080, h: 1920, label: 'TikTok',     gradientStart: 0.58, titleSize: 56, descSize: 32, titleMaxW: 920, descMaxW: 900 },
        pinterest: { w: 1000, h: 1500, label: 'Pinterest',  gradientStart: 0.48, titleSize: 58, descSize: 34, titleMaxW: 860, descMaxW: 840 }
    };

    var LOGO_CFG = { width: 80, topMargin: 70, rightMargin: 5 };
    var GOLD = '#D7BF81';
