...
(function() {
    ...
    async function detectUserCountry() {
        try {
            ...
            if (forcedCountry) {
                ...
                console.log('PM Coffee Widget: Country FORCED via URL =', detectedCountry, '→ Currency:', detectedCurrency);
            ...
            if (detectedCountry) {
                ...
                console.log('PM Coffee Widget: Country detected =', detectedCountry, '→ Currency:', detectedCurrency);
    ...
    function updatePayPalCurrency(currency) {
        ...
        if (currencyInput) {
            ...
            console.log('PM Coffee Widget: PayPal currency set to', currency);
        }
    }
    ...
    if (window.location.search.includes('debug=coffee')) {
        console.log('PM Coffee Widget Debug:', {
