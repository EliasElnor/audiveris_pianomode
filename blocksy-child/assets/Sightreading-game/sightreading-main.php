...
class PianoMode_SightReading_Game {
    ...
    private $difficulty_levels = array(
        'beginner' => array(
            'name' => 'Beginner',
            'description' => 'Une note après l\'autre, tempo lent, Do Majeur uniquement - Morceaux courts (4 mesures)',
            ...
            'measure_count' => 4 // Short exercises for beginners
        ),
        'elementary' => array(
            'name' => 'Elementary',
            'description' => 'Intervalles occasionnels (2 notes), range étendu, croches - Morceaux moyens (8 mesures)',
            ...
            'measure_count' => 8 // Medium-length exercises
        ),
        'intermediate' => array(
            'name' => 'Intermediate',
            'description' => 'Accords harmoniques (2-3 notes) alignés Sol/Fa selon tonalité - Morceaux longs (12 mesures)',
            ...
            'use_grand_staff' => true,
            'staff_preference' => 'both',
            'measure_count' => 12, // Longer exercises
            'use_harmonic_chords' => true // ✅ NEW: Enable intelligent harmonic chords aligned across staves
        ),
        'advanced' => array(
            'name' => 'Advanced',
            'description' => 'Triades & accords 7ème (3-4 notes) harmoniques complexes - Morceaux très longs (16 mesures)',
            ...
            'use_grand_staff' => true,
            'staff_preference' => 'both',
            'measure_count' => 16, // Very long exercises
            'use_harmonic_chords' => true // ✅ Intelligent harmonic chords
        ),
        'expert' => array(
            'name' => 'Expert',
            'description' => 'Accords jazz complexes (4+ notes) polyharmoniques - Morceaux professionnels (24 mesures)',
            ...
            'use_grand_staff' => true,
            'staff_preference' => 'both',
            'measure_count' => 24, // Professional-length exercises
                ...
                <div class="srt-toolbar-content">
                    ...
                    <div class="srt-toolbar-section srt-mode-section">
                        ...
                        <div class="srt-mode-selector" id="srtModeSelector">
                            <button class="srt-mode-btn" data-mode="wait">Wait</button>
                            <button class="srt-mode-btn" data-mode="scroll">Scroll</button>
                            <button class="srt-mode-btn active" data-mode="free">Free</button>
                        </div>
                    </div>
                    ...
                    <!-- Free Mode Save/Export (hidden by default, shown in free mode) -->
                    <div class="srt-toolbar-section srt-freemode-actions" id="srtFreeModeActions" style="display: none;">
                        <button class="srt-btn" id="srtSaveComposition" title="Save composition">
                        ...
                        <button class="srt-btn" id="srtExportXML" title="Export as MusicXML">
                            <svg class="srt-icon" viewBox="0 0 24 24"><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/></svg>
                            <span>Export</span>
                        </button>
                        <button class="srt-btn" id="srtReplayComposition" title="Replay saved composition" style="display: none;">
