    ...
    function pianomode_render_author_badge() {
        ...
        <div class="pm-author-badge">
            <div class="pm-author-badge-photo">
                <img src="' . esc_url($photo_url) . '" alt="Cl&eacute;ment C.G. - Founder of PianoMode" loading="lazy" decoding="async" width="220" height="220">
            </div>
            <div class="pm-author-badge-info">
                <div class="pm-author-badge-header">
                    <span class="pm-author-badge-name">Cl&eacute;ment C.G.</span>
                    <span class="pm-author-badge-role">Founder</span>
                </div>
                <p class="pm-author-badge-bio">
                    Graduate in Law &amp; Organizational Management and working on IT projects for 5 years after 3 years as project manager in music labels. Pianist since the age of 4 with intensive training through 18. On a mission to democratize piano learning and keep it interactive in the digital age.
                </p>
