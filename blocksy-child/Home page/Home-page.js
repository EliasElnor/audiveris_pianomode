...
(function() {
    ...
    class HomePageController {
        ...
        attachEventListeners() {
            ...
            // Hero "Explore PianoMode" button — scroll to studio banner
            this.dom.scrollExploreBtn?.addEventListener('click', () => {
                this.scrollToSection(this.dom.exploreSection);
            });

            // Control bar "Explore PianoMode" button — scroll to studio banner
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', () => { init(); initPrefetch(); });
    } else {
        init();
        initPrefetch();
    }
