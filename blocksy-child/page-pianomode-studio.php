...
.rec-btn:not(:disabled):hover {
    ...
    border-color: rgba(215, 191, 129, 0.45);
...
.download-btn:hover {
    ...
    box-shadow: 0 6px 24px rgba(215, 191, 129, 0.25);
}
...
.midi-btn.active {
    ...
    border-color: var(--pm-primary);
    color: var(--pm-primary);
    box-shadow: 0 0 16px rgba(215, 191, 129, 0.3);
}
...
.notation-toggle.active {
    ...
    border-color: var(--pm-primary);
    color: var(--pm-primary);
    box-shadow: 0 0 12px rgba(215, 191, 129, 0.15);
}
...
.sustain-btn.active {
    background: rgba(215, 191, 129, 0.2);
    border-color: var(--pm-primary);
    box-shadow: 0 0 12px rgba(215, 191, 129, 0.2);
}
...
.component-title-v2 {
    font-size: 1.6rem;
    font-weight: 800;
    background: linear-gradient(135deg, #E6D4A8, #D7BF81, #C4A84D);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    background-clip: text;
    margin: 0;
...
/* Header-right buttons: ALWAYS centered on screen */
.header-right-v2 {
    display: flex;
    gap: 8px;
    align-items: center;
...
.component-toggle-btn-v2:active {
    transform: translateY(0);
}
...
.drum-transport-btn:hover {
    ...
    border-color: var(--pm-primary);
    transform: translateY(-2px);
    box-shadow: 0 4px 16px rgba(215, 191, 129, 0.2), inset 0 1px 0 rgba(255,255,255,0.05);
}

.drum-transport-btn:active {
    transform: translateY(0);
}
...
.drum-step {
    aspect-ratio: 1;
    background: linear-gradient(145deg, rgba(45, 42, 38, 0.9) 0%, rgba(30, 28, 25, 0.95) 100%);
    border: 1px solid rgba(215, 191, 129, 0.15);
    border-radius: 6px;
    cursor: pointer;
...
.drum-step:hover {
    background: linear-gradient(145deg, rgba(65, 55, 40, 0.9) 0%, rgba(45, 40, 32, 0.95) 100%);
    border-color: rgba(215, 191, 129, 0.5);
    transform: scale(1.08);
    box-shadow: 0 0 8px rgba(215, 191, 129, 0.15), inset 0 1px 2px rgba(0, 0, 0, 0.3);
}

.drum-step.active {
    background: linear-gradient(145deg, var(--pm-primary) 0%, rgba(215, 191, 129, 0.55) 100%);
    border-color: var(--pm-primary);
    box-shadow: 0 0 14px rgba(215, 191, 129, 0.45), inset 0 2px 4px rgba(255, 255, 255, 0.25), 0 2px 6px rgba(215, 191, 129, 0.2);
}
...
.drum-step:nth-child(4n+1) {
    ...
    border-left-color: rgba(215, 191, 129, 0.35);
    margin-left: 2px;
}

.drum-step.active:nth-child(4n+1),
.drum-step.active:nth-child(4n+3) {
    background: linear-gradient(145deg, var(--pm-primary) 0%, rgba(195, 171, 109, 0.55) 100%);
}

@keyframes drum-step-pulse {
    0% { transform: scale(1); }
    50% { transform: scale(1.15); box-shadow: 0 0 18px rgba(215, 191, 129, 0.7); }
    100% { transform: scale(1); }
}
...
.studio-hero-v2 .musical-note:nth-child(1) {
    top: 0;
    left: 0;
    animation: noteFloat1 36s ease-in-out infinite;
}

.studio-hero-v2 .musical-note:nth-child(2) {
    top: 0;
    left: 0;
    animation: noteFloat2 42s ease-in-out infinite;
    animation-delay: 2s;
}
...
.studio-hero-v2 .musical-note:nth-child(3) {
    top: 0;
    left: 0;
    animation: noteFloat3 38s ease-in-out infinite;
    animation-delay: 5s;
}
...
.studio-hero-v2 .musical-note:nth-child(4) {
    top: 0;
    left: 0;
    animation: noteFloat4 44s ease-in-out infinite;
    animation-delay: 1s;
}

/* Animations notes - faster appearance, more visible, fluid motion */
@keyframes noteFloat1 {
    0% { transform: translate(10vw, 20vh); opacity: 0; }
    3% { opacity: 0.5; }
    15% { transform: translate(25vw, 35vh); opacity: 0.55; }
    30% { transform: translate(45vw, 55vh); opacity: 0.35; }
    45% { transform: translate(70vw, 40vh); opacity: 0.6; }
    60% { transform: translate(55vw, 65vh); opacity: 0.3; }
    75% { transform: translate(30vw, 50vh); opacity: 0.5; }
    90% { transform: translate(15vw, 30vh); opacity: 0.25; }
    97% { opacity: 0.1; }
...
@keyframes noteFloat2 {
    ...
    3% { opacity: 0.5; }
    20% { transform: translate(60vw, 45vh); opacity: 0.45; }
    35% { transform: translate(40vw, 30vh); opacity: 0.6; }
    50% { transform: translate(20vw, 55vh); opacity: 0.35; }
    65% { transform: translate(35vw, 70vh); opacity: 0.55; }
    80% { transform: translate(55vw, 50vh); opacity: 0.3; }
    95% { opacity: 0.1; }
...
@keyframes noteFloat3 {
    ...
    3% { opacity: 0.45; }
    18% { transform: translate(30vw, 50vh); opacity: 0.55; }
    36% { transform: translate(15vw, 35vh); opacity: 0.4; }
    54% { transform: translate(40vw, 20vh); opacity: 0.6; }
    72% { transform: translate(65vw, 45vh); opacity: 0.35; }
    88% { transform: translate(55vw, 60vh); opacity: 0.25; }
    97% { opacity: 0.08; }
...
@keyframes noteFloat4 {
    ...
    3% { opacity: 0.5; }
    22% { transform: translate(40vw, 40vh); opacity: 0.5; }
    40% { transform: translate(65vw, 55vh); opacity: 0.4; }
    55% { transform: translate(80vw, 35vh); opacity: 0.55; }
    70% { transform: translate(55vw, 25vh); opacity: 0.3; }
    85% { transform: translate(35vw, 50vh); opacity: 0.45; }
    95% { opacity: 0.1; }
    100% { transform: translate(20vw, 60vh); opacity: 0; }
}

.studio-hero-v2 .musical-note:nth-child(5) {
    top: 0; left: 0;
    animation: noteFloat5 40s ease-in-out infinite;
    animation-delay: 3s;
    font-size: clamp(1.2rem, 2.5vw, 2rem);
}
.studio-hero-v2 .musical-note:nth-child(6) {
    top: 0; left: 0;
    animation: noteFloat6 46s ease-in-out infinite;
    animation-delay: 6s;
    font-size: clamp(1rem, 2vw, 1.8rem);
}
.studio-hero-v2 .musical-note:nth-child(7) {
    top: 0; left: 0;
    animation: noteFloat7 34s ease-in-out infinite;
    animation-delay: 1.6s;
    font-size: clamp(1.8rem, 3.5vw, 3rem);
}
.studio-hero-v2 .musical-note:nth-child(8) {
    top: 0; left: 0;
    animation: noteFloat8 42s ease-in-out infinite;
    animation-delay: 4s;
    font-size: clamp(1.3rem, 2.8vw, 2.2rem);
}
.studio-hero-v2 .musical-note:nth-child(9) {
    top: 0; left: 0;
    animation: noteFloat9 38s ease-in-out infinite;
    animation-delay: 8s;
    font-size: clamp(1rem, 2.2vw, 1.6rem);
}
.studio-hero-v2 .musical-note:nth-child(10) {
    top: 0; left: 0;
    animation: noteFloat10 48s ease-in-out infinite;
    animation-delay: 2s;
    font-size: clamp(1.5rem, 3.2vw, 2.8rem);
}
.studio-hero-v2 .musical-note:nth-child(11) {
    top: 0; left: 0;
    animation: noteFloat11 36s ease-in-out infinite;
    animation-delay: 7s;
    font-size: clamp(1.1rem, 2vw, 1.5rem);
}
.studio-hero-v2 .musical-note:nth-child(12) {
    top: 0; left: 0;
    animation: noteFloat12 44s ease-in-out infinite;
    animation-delay: 4s;
...
@keyframes noteFloat5 {
    ...
    3% { opacity: 0.45; }
    20% { transform: translate(70vw, 40vh); opacity: 0.5; }
    40% { transform: translate(45vw, 60vh); opacity: 0.3; }
    60% { transform: translate(25vw, 35vh); opacity: 0.55; }
    80% { transform: translate(55vw, 20vh); opacity: 0.35; }
    95% { opacity: 0.1; }
...
@keyframes noteFloat6 {
    ...
    3% { opacity: 0.5; }
    25% { transform: translate(20vw, 25vh); opacity: 0.4; }
    45% { transform: translate(50vw, 15vh); opacity: 0.55; }
    65% { transform: translate(75vw, 45vh); opacity: 0.3; }
    85% { transform: translate(40vw, 65vh); opacity: 0.45; }
    96% { opacity: 0.08; }
    100% { transform: translate(5vw, 45vh); opacity: 0; }
}

@keyframes noteFloat7 {
    0% { transform: translate(60vw, 80vh); opacity: 0; }
    3% { opacity: 0.4; }
    22% { transform: translate(80vw, 55vh); opacity: 0.5; }
    44% { transform: translate(35vw, 30vh); opacity: 0.35; }
    66% { transform: translate(15vw, 60vh); opacity: 0.55; }
    88% { transform: translate(50vw, 75vh); opacity: 0.25; }
    97% { opacity: 0.08; }
    100% { transform: translate(60vw, 80vh); opacity: 0; }
}

@keyframes noteFloat8 {
    0% { transform: translate(40vw, 10vh); opacity: 0; }
    3% { opacity: 0.5; }
    20% { transform: translate(15vw, 30vh); opacity: 0.4; }
    40% { transform: translate(30vw, 55vh); opacity: 0.55; }
    60% { transform: translate(60vw, 70vh); opacity: 0.3; }
    80% { transform: translate(80vw, 40vh); opacity: 0.45; }
    95% { opacity: 0.1; }
    100% { transform: translate(40vw, 10vh); opacity: 0; }
}

@keyframes noteFloat9 {
    0% { transform: translate(90vw, 50vh); opacity: 0; }
    3% { opacity: 0.4; }
    18% { transform: translate(65vw, 30vh); opacity: 0.55; }
    36% { transform: translate(40vw, 50vh); opacity: 0.3; }
    54% { transform: translate(20vw, 70vh); opacity: 0.5; }
    72% { transform: translate(50vw, 45vh); opacity: 0.35; }
    90% { transform: translate(75vw, 60vh); opacity: 0.2; }
    100% { transform: translate(90vw, 50vh); opacity: 0; }
}

@keyframes noteFloat10 {
    0% { transform: translate(30vw, 75vh); opacity: 0; }
    3% { opacity: 0.4; }
    15% { transform: translate(10vw, 55vh); opacity: 0.45; }
    35% { transform: translate(25vw, 20vh); opacity: 0.5; }
    55% { transform: translate(55vw, 35vh); opacity: 0.35; }
    75% { transform: translate(70vw, 65vh); opacity: 0.55; }
    94% { opacity: 0.1; }
    100% { transform: translate(30vw, 75vh); opacity: 0; }
}

@keyframes noteFloat11 {
    0% { transform: translate(70vw, 10vh); opacity: 0; }
    3% { opacity: 0.5; }
    22% { transform: translate(50vw, 35vh); opacity: 0.35; }
    42% { transform: translate(25vw, 50vh); opacity: 0.5; }
    62% { transform: translate(10vw, 25vh); opacity: 0.4; }
    82% { transform: translate(45vw, 15vh); opacity: 0.55; }
    96% { opacity: 0.08; }
    100% { transform: translate(70vw, 10vh); opacity: 0; }
}

@keyframes noteFloat12 {
    0% { transform: translate(15vw, 40vh); opacity: 0; }
    3% { opacity: 0.45; }
    20% { transform: translate(35vw, 65vh); opacity: 0.5; }
    38% { transform: translate(60vw, 45vh); opacity: 0.3; }
    56% { transform: translate(85vw, 25vh); opacity: 0.55; }
    74% { transform: translate(65vw, 55vh); opacity: 0.4; }
    94% { opacity: 0.1; }
    100% { transform: translate(15vw, 40vh); opacity: 0; }
}
...
.daw-effects-toggle {
    ...
    cursor: pointer;
    transition: all 0.2s ease;
    /* Mobile: ensure tappable */
    -webkit-tap-highlight-color: rgba(215, 191, 129, 0.3);
...
/* Microphone toggle same treatment */
.mic-toggle {
    -webkit-tap-highlight-color: rgba(215, 191, 129, 0.3);
    touch-action: manipulation;
    user-select: none;
...
/* ===== VOCAL PLAYER WITH PROGRESS BAR ===== */
.vocal-player-container {
    display: flex;
    align-items: center;
    gap: 8px;
    margin-top: 8px;
...
.vocal-play-pause-btn.playing {
    border-color: #ff6b6b;
    color: #ff6b6b;
    background: rgba(255, 107, 107, 0.15);
}

.vocal-progress-wrapper {
    flex: 1;
    display: flex;
    flex-direction: column;
    gap: 2px;
...
.vocal-progress-fill {
    height: 100%;
    background: linear-gradient(90deg, var(--pm-primary-dark), var(--pm-primary));
    border-radius: 3px;
    width: 0%;
    transition: width 0.1s linear;
}

.vocal-progress-bar:hover .vocal-progress-fill {
...
.audio-cut-editor .editor-waveform-container {
    position: relative;
    height: 80px;
    background: rgba(0, 0, 0, 0.4);
...
.audio-cut-editor .editor-waveform-container canvas {
    width: 100%;
    height: 100%;
}

.audio-cut-editor .editor-trim-region {
    position: absolute;
    top: 0;
    height: 100%;
...
.audio-cut-editor .editor-trim-handle {
    position: absolute;
    top: 0;
    width: 12px;
    height: 100%;
...
.audio-cut-editor .editor-trim-handle::after {
    content: '⋮';
    position: absolute;
    top: 50%;
    left: 50%;
...
.audio-cut-editor .editor-trim-handle.left {
    left: 0;
    background: linear-gradient(90deg, rgba(255,193,7,0.3), transparent);
}

.audio-cut-editor .editor-trim-handle.right {
    right: 0;
    background: linear-gradient(-90deg, rgba(255,193,7,0.3), transparent);
}

.audio-cut-editor .editor-time-info {
    display: flex;
    justify-content: space-between;
    align-items: center;
    font-size: 11px;
...
.audio-cut-editor .editor-time-info .time-value {
    color: #FFC107;
    font-weight: 600;
    font-variant-numeric: tabular-nums;
}

.audio-cut-editor .editor-controls {
    display: flex;
    gap: 8px;
    flex-wrap: wrap;
    align-items: center;
...
.audio-cut-editor .editor-controls button {
    padding: 6px 14px;
    border-radius: 5px;
    border: 1px solid;
    font-size: 11px;
...
.audio-cut-editor .editor-controls .preview-btn {
    background: rgba(33, 150, 243, 0.2);
    border-color: rgba(33, 150, 243, 0.5);
    color: #64B5F6;
}
.audio-cut-editor .editor-controls .preview-btn:hover {
    background: rgba(33, 150, 243, 0.35);
    border-color: #2196F3;
}

.audio-cut-editor .editor-controls .apply-btn {
    background: rgba(76, 175, 80, 0.2);
    border-color: rgba(76, 175, 80, 0.5);
    color: #81C784;
}
.audio-cut-editor .editor-controls .apply-btn:hover {
    background: rgba(76, 175, 80, 0.35);
    border-color: #4CAF50;
}

.audio-cut-editor .editor-controls .cancel-btn {
    background: rgba(244, 67, 54, 0.15);
    border-color: rgba(244, 67, 54, 0.4);
    color: #ef9a9a;
}
.audio-cut-editor .editor-controls .cancel-btn:hover {
    background: rgba(244, 67, 54, 0.3);
    border-color: #f44336;
}

/* Backtrack Edit Button */
.backtracks-btn.edit-btn {
    background: rgba(60, 50, 20, 0.85);
    border-color: rgba(255, 193, 7, 0.4);
    color: #FFC107;
}
.backtracks-btn.edit-btn:hover {
    background: rgba(80, 65, 20, 0.95);
    border-color: #FFC107;
...
/* ===== MASTER OUTPUT VOLUME CONTROL (Transport Bar) ===== */
...
.master-output-slider {
    ...
    -webkit-appearance: none;
    appearance: none;
    background: linear-gradient(90deg, rgba(215, 191, 129, 0.3), rgba(215, 191, 129, 0.6));
    border-radius: 2px;
    outline: none;
    cursor: pointer;
}

.master-output-slider::-webkit-slider-thumb {
    -webkit-appearance: none;
    appearance: none;
    width: 14px;
    height: 14px;
    border-radius: 50%;
    background: var(--pm-primary, #D7BF81);
    border: 2px solid rgba(25, 25, 25, 0.9);
    cursor: pointer;
    box-shadow: 0 0 6px rgba(215, 191, 129, 0.4);
}

.master-output-slider::-moz-range-thumb {
    width: 14px;
    height: 14px;
    border-radius: 50%;
    background: var(--pm-primary, #D7BF81);
...
.track-action-btn:active {
    transform: translateY(0);
    box-shadow: 0 1px 4px rgba(215, 191, 129, 0.15);
}
...
/* Global playhead spanning ruler + all tracks - bold golden bar */
.daw-global-playhead {
    position: absolute;
    top: 0;
    bottom: 0;
    left: 0;
    width: 3px;
    background: linear-gradient(180deg, #E6D4A8, var(--pm-primary), #E6D4A8);
    box-shadow: 0 0 12px rgba(215, 191, 129, 0.8), 0 0 4px var(--pm-primary), 0 0 20px rgba(215, 191, 129, 0.4);
    z-index: 50;
    pointer-events: none;
...
.daw-global-playhead::before {
    ...
    border-top: 10px solid #E6D4A8;
    filter: drop-shadow(0 0 6px rgba(215, 191, 129, 0.9));
}

/* Click-to-seek cursor on waveform areas */
...
.track-name span, .track-name {
    display: inline-block;
}
.track-name.marquee {
    text-overflow: clip;
}
.track-name.marquee > .marquee-inner {
    display: inline-block;
...
/* Transfer to Track button - same size as mute/solo buttons */
.track-mix-btn.master-transfer-btn {
    width: 28px;
    height: 22px;
    font-size: 13px;
    background: rgba(215,191,129,0.15);
...
.track-mix-btn.master-transfer-btn:hover {
    background: rgba(215,191,129,0.3);
    border-color: var(--pm-primary);
    color: var(--pm-primary);
}
...
/* Track/Master play mode visual distinction */
.audio-track.play-mode-inactive {
    transition: opacity 0.3s ease, filter 0.3s ease;
}

/* Keep mixer controls (knobs, faders, buttons) ALWAYS interactive and visible in ALL play modes */
.audio-track .track-mixer-controls {
    pointer-events: auto !important;
    opacity: 1 !important;
...
/* Ensure all knobs, faders, and buttons inside mixer controls are always visible */
.audio-track .track-mixer-controls .knob-mini-visual,
.audio-track .track-mixer-controls .fader-mini-track,
.audio-track .track-mixer-controls .fader-mini-fill,
.audio-track .track-mixer-controls .fader-mini-value,
.audio-track .track-mixer-controls .track-mix-btn,
.audio-track .track-mixer-controls .knob-mini-label {
    opacity: 1 !important;
    filter: none !important;
    pointer-events: auto !important;
}

/* Grey out the waveform and time info, but NOT the mixer */
.audio-track.play-mode-inactive .track-waveform-canvas,
.audio-track.play-mode-inactive .track-time-info {
    pointer-events: none;
    opacity: 0.35;
    filter: grayscale(0.6);
}

/* Master output volume slider in transport bar - never grayed */
.master-output-control {
    opacity: 1 !important;
    filter: none !important;
}

.audio-track.play-mode-active {
    opacity: 1;
    filter: none;
    pointer-events: auto;
    transition: opacity 0.3s ease, filter 0.3s ease;
    box-shadow: inset 0 0 0 1px rgba(215, 191, 129, 0.3);
}

/* Pulsing border for currently playing mode */
.audio-track.play-mode-playing {
    box-shadow: inset 0 0 0 1px rgba(76, 175, 80, 0.6);
    animation: playModePulse 2s ease-in-out infinite;
}

@keyframes playModePulse {
    0%, 100% { box-shadow: inset 0 0 0 1px rgba(76, 175, 80, 0.3); }
    50% { box-shadow: inset 0 0 0 1px rgba(76, 175, 80, 0.7); }
}
...
/* Floating time tooltip shown during clip drag */
.clip-drag-tooltip {
    position: absolute;
    top: -26px;
    left: 50%;
...
.audio-clip-name.marquee {
    text-overflow: clip;
}
.audio-clip-name.marquee > .marquee-inner {
    display: inline-block;
    animation: track-name-scroll 6s linear infinite;
    padding-right: 30px;
}
...
/* ===== PIANO SEQUENCER & BACKTRACKS SHARED CONTAINER ===== */
/* Both sequencer and backtracks are inside virtual piano body - align them identically */
.piano-sequencer-container,
...
/* Override the old sequencer-specific styles */
.piano-sequencer-container {
...
/* ===== BACK TRACKS PLAYER ===== */
/* Container styles now shared with .piano-sequencer-container above */
...
/* Backtrack Volume Control */
.backtracks-volume-control {
    display: flex;
    align-items: center;
    gap: 8px;
    margin-top: 4px;
...
.bt-volume-slider::-moz-range-thumb {
    width: 14px;
    height: 14px;
    border-radius: 50%;
    background: var(--pm-primary, #D7BF81);
...
/* Tracks Grid - adapts columns to track count */
...
/* 2 tracks: each takes half */
.sequencer-tracks-grid.tracks-2 {
    grid-template-columns: repeat(2, 1fr);
}

/* 3 tracks: all 3 fit in one row, reduced size */
.sequencer-tracks-grid.tracks-3 {
    grid-template-columns: repeat(3, 1fr);
}
.sequencer-tracks-grid.tracks-3 .sequencer-track-card {
    min-width: 0;
}
.sequencer-tracks-grid.tracks-3 .track-name {
    font-size: 0.75rem;
}
.sequencer-tracks-grid.tracks-3 .track-controls-row .track-btn {
    padding: 0 10px;
    font-size: 0.65rem;
}
.sequencer-tracks-grid.tracks-3 .track-controls-row .track-btn .btn-label {
    font-size: 0.65rem;
}
.sequencer-tracks-grid.tracks-3 .track-notes-count,
.sequencer-tracks-grid.tracks-3 .track-duration {
    font-size: 0.6rem;
}

/* 4+ tracks: 2 per row, wrapping into multiple rows */
.sequencer-tracks-grid.tracks-4plus {
    grid-template-columns: repeat(2, 1fr);
}
.sequencer-tracks-grid.tracks-4plus .sequencer-track-card {
    min-width: 0;
}
.sequencer-tracks-grid.tracks-4plus .track-name {
    font-size: 0.75rem;
}
.sequencer-tracks-grid.tracks-4plus .track-controls-row .track-btn {
    padding: 0 8px;
    font-size: 0.62rem;
}
.sequencer-tracks-grid.tracks-4plus .track-controls-row .track-btn .btn-label {
    font-size: 0.62rem;
}
...
.sequencer-track-card.note-hit {
    background: linear-gradient(180deg, rgba(215, 191, 129, 0.12) 0%, rgba(18, 18, 18, 0.98) 100%);
    transition: background 0.1s ease;
}

@keyframes recordPulse {
    0%, 100% { box-shadow: 0 0 15px rgba(255, 107, 107, 0.2); }
    50% { box-shadow: 0 0 25px rgba(255, 107, 107, 0.45); }
}
...
.track-controls-row .track-btn .btn-icon {
    display: none;
}

.track-controls-row .track-btn .btn-label {
    font-size: 0.72rem;
    line-height: 36px;
    height: 36px;
    text-overflow: ellipsis;
...
/* Tooltip on hover */
.track-controls-row .track-btn .btn-tooltip {
    position: absolute;
    bottom: calc(100% + 8px);
    left: 50%;
...
.track-controls-row .track-btn .btn-tooltip::after {
    content: '';
    position: absolute;
    top: 100%;
    left: 50%;
...
.track-controls-row .track-btn:hover .btn-tooltip {
    opacity: 1;
    transform: translateX(-50%) scale(1);
}

.track-controls-row .track-btn:hover {
...
.track-btn.rec-btn .btn-tooltip { border-color: rgba(255, 107, 107, 0.4); }
...
.track-btn.rec-btn.has-recording:hover {
    background: rgba(50, 100, 50, 0.85);
}
...
.track-btn.play-btn:hover {
    border-color: #4CAF50;
    background: rgba(35, 75, 35, 0.95);
    box-shadow: 0 0 12px rgba(76, 175, 80, 0.25);
}

.track-btn.play-btn .btn-tooltip { border-color: rgba(76, 175, 80, 0.4); }
...
.track-btn.loop-btn .btn-tooltip { border-color: rgba(33, 150, 243, 0.4); }

.track-btn.loop-btn.active {
    background: linear-gradient(135deg, #2196F3 0%, #1976D2 100%);
    border-color: #2196F3;
    color: white;
    box-shadow: 0 0 14px rgba(33, 150, 243, 0.5);
}

/* EDIT / TRIM Button - Yellow themed to match other buttons */
.track-btn.edit-btn {
...
.track-btn.edit-btn .btn-tooltip { border-color: rgba(255, 193, 7, 0.4); }
...
.track-btn.clear-btn:hover {
    border-color: #f44336;
    background: rgba(70, 35, 35, 0.95);
    color: #ff6b6b;
    box-shadow: 0 0 12px rgba(244, 67, 54, 0.25);
}

.track-btn.clear-btn .btn-tooltip { border-color: rgba(244, 67, 54, 0.4); }

/* SEND Button */
.track-btn.send-btn {
    background: rgba(45, 30, 55, 0.85);
...
.track-btn.send-btn .btn-tooltip { border-color: rgba(156, 39, 176, 0.4); }
...
/* Master track knobs always visible above gray overlay */
.audio-track.master-track .track-mixer-controls {
    position: relative;
    z-index: 10;
    opacity: 1 !important;
    filter: none !important;
...
.audio-track.master-track .knob-mini-visual,
.audio-track.master-track .fader-mini-track,
.audio-track.master-track .track-mixer-buttons {
    opacity: 1 !important;
    filter: none !important;
    pointer-events: auto !important;
}
...
/* Gray out green recording clips when playing tracks */
.master-recording-clip.clip-grayed-out {
    opacity: 0.35;
    filter: grayscale(0.8);
    pointer-events: none;
    transition: opacity 0.3s ease, filter 0.3s ease;
...
/* ================================================================
   COMPREHENSIVE RESPONSIVE OVERHAUL - Mobile/Tablet Portrait Mode
   ================================================================ */
...
/* --- RECORDING STUDIO: Transport bar responsive --- */
@media (max-width: 768px) {
    .daw-transport-unified {
        flex-wrap: wrap !important;
        gap: 8px !important;
    ...
    .toolbar-toggle-btn span:last-child {
        display: none;
    }
    .master-output-control {
...
/* --- RECORDING STUDIO: Track actions (Export, Add Track) --- */
@media (max-width: 768px) {
    .tracks-header {
        flex-wrap: wrap !important;
        gap: 8px !important;
...
/* --- AUDIO TRACKS: Responsive layout --- */
@media (max-width: 768px) {
    .audio-track {
        flex-wrap: wrap !important;
        gap: 6px !important;
...
/* --- PIANO BOTTOM CONTROLS: Responsive --- */
@media (max-width: 768px) {
    .piano-bottom-controls {
        flex-direction: column !important;
        gap: 10px !important;
...
/* --- RECORDING STUDIO SIDEBAR: Portrait responsive --- */
@media (max-width: 768px) {
    .recording-studio-sidebar {
        padding: 10px !important;
    }
...
/* --- PREVENT ANY OVERFLOW IN PORTRAIT MODE --- */
@media (max-width: 768px) and (orientation: portrait) {
    .piano-main {
...
/* ===== MOBILE PORTRAIT - SEQUENCER TRACKS STACK + TIMELINE PER TRACK ===== */
@media (max-width: 768px) and (orientation: portrait) {
    /* Force single column for sequencer tracks grid */
    .sequencer-tracks-grid,
    .sequencer-tracks-grid.tracks-2,
    .sequencer-tracks-grid.tracks-3,
    .sequencer-tracks-grid.tracks-4plus {
    ...
    /* Track card: compact with timeline visible above the notes area */
    .sequencer-track-card {
        border-radius: 10px !important;
    }
    ...
    /* Track visualization - compact but visible as timeline per track */
    .track-visualization {
        height: 40px !important;
        border-top: 1px solid rgba(215, 191, 129, 0.1);
    ...
    /* Track buttons row: wrap into two rows for touch-friendly targets */
    .track-controls-row {
    ...
    /* DAW timeline ruler: hide the long ruler bar, each track has its own visualization */
    .timeline-ruler-container {
        display: none !important;
    }

    /* DAW audio tracks: stacked cards, no long horizontal bar */
    .audio-tracks-container {
        display: flex !important;
        flex-direction: column !important;
        gap: 8px !important;
    ...
    .audio-track .track-time-info {
        border-right: none !important;
        border-bottom: 1px solid rgba(215, 191, 129, 0.15) !important;
        padding: 8px 10px !important;
    }
    ...
    /* Waveform area acts as per-track timeline */
    .audio-track .track-waveform-canvas {
...
/* ===== MOBILE LANDSCAPE - KEYBOARD STRUCTURE FIX ===== */
@media (max-width: 768px) and (orientation: landscape) {
    /* Piano keyboard container: ensure proper scroll and sizing in landscape */
    .piano-keyboard-container {
        overflow-x: auto !important;
        overflow-y: visible !important;
        -webkit-overflow-scrolling: touch;
    ...
    /* Keyboard flex layout must remain intact in landscape */
    .piano-keyboard {
        display: flex !important;
        flex-direction: row !important;
    ...
    /* White keys: maintain flex row structure */
    .piano-key.white {
        flex-shrink: 0 !important;
        box-sizing: border-box !important;
        display: flex !important;
    ...
    /* Black keys: absolute positioning must be preserved */
    .piano-key.black {
        position: absolute !important;
        box-sizing: border-box !important;
    }

    /* Note display compact in landscape */
    .note-display {
        gap: 1px !important;
    }
    .note-us {
    ...
    /* Piano bottom controls: row layout for landscape */
    .piano-bottom-controls {
        flex-direction: row !important;
        flex-wrap: wrap !important;
        gap: 6px !important;
    ...
    /* Sequencer tracks: 2 columns in landscape */
    .sequencer-tracks-grid,
    .sequencer-tracks-grid.tracks-2 {
        grid-template-columns: repeat(2, 1fr) !important;
        gap: 10px !important;
    ...
    /* Track buttons compact in landscape */
    .track-controls-row .track-btn {
        height: 30px !important;
        min-height: 30px !important;
    ...
    /* DAW tracks: horizontal layout restored in landscape */
    .audio-track {
        grid-template-columns: 120px 180px 1fr !important;
    ...
    .audio-track .track-time-info,
    .audio-track .track-mixer-controls {
        border-right: 1px solid rgba(215, 191, 129, 0.2) !important;
        border-bottom: none !important;
    }

    /* Timeline ruler visible in landscape */
    .timeline-ruler-container {
        display: grid !important;
    }
}
...
.mic-studio-icon { font-size: 24px; }
...
.mic-feature-tabs::-webkit-scrollbar { display: none; }
.mic-feature-tab {
    padding: 8px 16px;
    border: none;
    background: rgba(30, 30, 30, 0.6);
...
.mic-feature-tab:hover { color: var(--pm-gold, #D7BF81); background: rgba(40, 40, 40, 0.8); }
.mic-feature-tab.active {
    color: var(--pm-gold, #D7BF81);
    background: rgba(215, 191, 129, 0.12);
    border-bottom: 2px solid var(--pm-gold, #D7BF81);
}
.mic-feature-panel {
    padding: 16px;
    border-top: 1px solid rgba(215, 191, 129, 0.1);
}
.mic-feature-panel.hidden { display: none; }
.mic-feature-header {
    display: flex;
    align-items: center;
    justify-content: space-between;
...
.mic-feature-toggle:hover { border-color: #4CAF50; background: rgba(76, 175, 80, 0.2); }
.mic-feature-toggle.active {
    background: rgba(76, 175, 80, 0.3);
    border-color: #4CAF50;
    color: #fff;
    box-shadow: 0 0 12px rgba(76, 175, 80, 0.3);
}
.pitch-detector-display { text-align: center; }
.pitch-detector-display.hidden { display: none; }
.tuner-gauge {
    position: relative;
    width: 100%;
    max-width: 300px;
...
.tuner-mark.center { color: #4CAF50; font-size: 14px; }
.tuner-needle {
    position: absolute;
    bottom: 5px;
    left: 50%;
...
.voice-to-sheet-display.hidden { display: none; }
.transcription-area {
    min-height: 60px;
    padding: 12px;
    background: rgba(10, 10, 10, 0.5);
...
.harmonization-display.hidden { display: none; }
.detected-key {
    padding: 12px;
    background: rgba(10, 10, 10, 0.4);
    border-radius: 8px;
...
.sing-to-play-display.hidden { display: none; }
.sing-to-play-info {
    text-align: center;
    padding: 20px;
}
...
.sing-current-note strong {
    font-size: 36px;
    color: var(--pm-gold, #D7BF81);
    display: block;
    margin-top: 8px;
}
.training-display.hidden { display: none; }
.training-target {
    text-align: center;
    padding: 20px;
    background: rgba(10, 10, 10, 0.4);
...
.autotune-display.hidden { display: none; }
...
.piano-key.pitch-highlight {
    background: rgba(76, 175, 80, 0.5) !important;
    box-shadow: 0 0 12px rgba(76, 175, 80, 0.4);
}
.piano-key.training-target {
...
@keyframes trainingPulse {
    ...
    50% { box-shadow: 0 0 24px rgba(255, 193, 7, 0.6); }
}
@media (max-width: 768px) {
    .mic-studio-transport { flex-direction: column; gap: 12px; }
    .mic-studio-level { width: 100%; }
    .mic-studio-buttons { width: 100%; justify-content: center; }
    .mic-feature-tabs { gap: 2px; }
    .mic-feature-tab { padding: 6px 10px; font-size: 10px; }
    .autotune-controls-grid { grid-template-columns: 1fr; }
    .tuner-note { font-size: 36px; }
    .training-target-note { font-size: 40px; }
}
.vocal-player-container {
    display: flex;
    align-items: center;
    ...
    <section class="piano-main" id="pianoSection">
        ...
        <div class="component-container-v2" id="appGuideComponent">
            ...
            <div class="component-body-v2 hidden" id="appGuideBody">
                <div class="guide-container" style="padding: 16px; max-width: 100%; color: var(--pm-text-primary);">
                    ...
                    <div class="guide-section" style="margin-bottom: 20px;">
                        ...
                        <div style="background: rgba(215,191,129,0.08); border-radius: 10px; padding: 14px; line-height: 1.7;">
                            ...
                            <ul style="margin-left: 20px; list-style: disc; font-size: 13px;">
                                ...
                                <li><strong>Microphone Studio</strong> - Record voice, pitch detection, training, autotune</li>
                    ...
                    <div class="guide-section" style="margin-bottom: 20px;">
                        ...
                        <div style="background: rgba(255,107,107,0.15); border: 2px solid #FF6B6B; border-radius: 10px; padding: 14px; line-height: 1.7;">
                            ...
                            <p style="color: var(--pm-text-primary); font-weight: 600; font-size: 13px;">Always use the <span style="color: var(--pm-primary);">Export Audio (Lossless)</span> or <span style="color: var(--pm-primary);">Export MIDI</span> buttons to save your recordings before leaving!</p>
                        </div>
                    </div>
                    ...
                    <div class="guide-section" style="margin-bottom: 20px;">
                        ...
                        <div style="background: rgba(215,191,129,0.08); border: 1px solid var(--pm-border); border-radius: 10px; padding: 14px; line-height: 1.7;">
                            ...
                            <ul style="margin-left: 20px; list-style: disc; color: var(--pm-text-secondary); font-size: 13px;">
                                ...
                                <li><strong>Preview with Play/Pause</strong> - Listen to your backtrack before recording</li>
                                ...
                                <li><strong>Send to Rec Studio</strong> to include the backtrack in your Recording Studio session</li>
                                <li><strong>Export your mix</strong> as a professional lossless audio file</li>
                            </ul>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 16px;">
                            ...
                            <div style="background: rgba(30,30,30,0.7); border: 1px solid var(--pm-border); border-radius: 10px; padding: 18px;">
                                ...
                                <ol style="font-size: 13px; line-height: 1.8; color: var(--pm-text-secondary); margin-left: 18px;">
                                    ...
                                    <li>Click "Send to Rec Studio" for Recording Studio</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 16px;">
                            ...
                            <div style="background: rgba(30,30,30,0.7); border: 1px solid var(--pm-border); border-radius: 10px; padding: 18px;">
                                ...
                                <ul style="font-size: 13px; line-height: 1.8; color: var(--pm-text-secondary);">
                                    ...
                                    <li><strong>Send to Rec Studio:</strong> Add beat to Recording Studio</li>
                    ...
                    <div class="guide-section" style="margin-bottom: 32px;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 16px;">
                            ...
                            <div style="background: rgba(30,30,30,0.7); border: 1px solid var(--pm-border); border-radius: 10px; padding: 18px;">
                                ...
                                <ul style="font-size: 13px; line-height: 1.8; color: var(--pm-text-secondary);">
                                    <li><strong>Track Volume:</strong> Fader from -40dB to +40dB (center = 0dB unity)</li>
                                    ...
                                    <li><strong>Master Time:</strong> Set total duration (type + Enter or use arrows)</li>
                                </ul>
                            </div>
                            <div style="background: rgba(30,30,30,0.7); border: 1px solid var(--pm-border); border-radius: 10px; padding: 18px;">
                                <h5 style="color: var(--pm-primary); margin-bottom: 12px; font-size: 1.1rem;">Exporting</h5>
                                <ul style="font-size: 13px; line-height: 1.8; color: var(--pm-text-secondary);">
                                    <li><strong>Export Audio (Lossless):</strong> Download as audio file</li>
                    ...
                    <div class="guide-section" style="margin-bottom: 32px;">
                        ...
                        <div style="background: rgba(30,30,30,0.7); border: 1px solid var(--pm-border); border-radius: 10px; padding: 18px;">
                            <ol style="font-size: 13px; line-height: 2; color: var(--pm-text-secondary); margin-left: 18px;">
                                <li><strong>Open "Microphone Studio"</strong> (below Recording Studio) and click "Show"</li>
                                ...
                                <li><strong>Click "Send"</strong> to add the recording to the Recording Studio mix</li>
                                <li><strong>Try features:</strong> Tuner, Training, Autotune</li>
                            </ol>
                    ...
                    <div class="guide-section">
                        ...
                        <div style="background: linear-gradient(135deg, rgba(215,191,129,0.12) 0%, rgba(215,191,129,0.05) 100%); border: 1px solid var(--pm-border); border-radius: 10px; padding: 18px;">
                            <ul style="font-size: 13px; line-height: 2; color: var(--pm-text-secondary); margin-left: 18px;">
                                ...
                                <li>Use <strong>Send to Rec Studio</strong> to bring all parts together in Recording Studio</li>
                                <li>Connect a <strong>MIDI keyboard</strong> via USB for the most realistic piano experience with ultra-low latency</li>
                                <li>Keep track faders at center (0dB) for unity gain - adjust only when mixing</li>
                                <li><strong>Export Audio (Lossless)</strong> to share your creations or import into other software</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="component-container-v2" id="recordingStudioComponent">
                    <div class="component-header-v2">
                        <div class="header-titles-v2">
                            ...
                            <p class="component-subtitle-v2">Professional DAW • Multi-track • Effects • Mixing • Export</p>
                        </div>
                    ...
                    <div class="component-body-v2 hidden" id="recordingStudioBody">
                        ...
                        <div class="daw-transport-unified">
                            ...
                            <!-- Master Time Control -->
                            <div class="toolbar-control-inline">
                                <label>Master Time</label>
                                <input type="number" id="dawMasterTime" value="30" min="1" max="9999" class="toolbar-input" title="Song duration in seconds (max 9999)">
                            ...
                            <!-- Master Output Volume (always accessible, not affected by track graying) -->
                            <div class="master-output-control" id="masterOutputControl" title="Master Output Volume">
                                <label class="master-output-label">Master Vol</label>
                                <input type="range" class="master-output-slider" id="masterOutputSlider" min="0" max="100" value="100" step="1">
                                <span class="master-output-value" id="masterOutputValue">100%</span>
                            </div>
                        </div>
                        ...
                        <div class="daw-tracks-section">
                            <div class="tracks-header">
                                ...
                                <div class="tracks-actions">
                                    ...
                                    <button class="track-action-btn" id="dawExportMIDI" title="Piano & Drum notes only, no effects or audio">
                                        <span class="btn-icon">🎹</span>
                                        <span>Export MIDI</span>
                                        <span style="font-size: 9px; color: rgba(215,191,129,0.6); white-space: nowrap;">(only notes and drums)</span>
                                    </button>
                                    <button class="track-action-btn" id="dawExportWAV">
                                        <span class="btn-icon">🎵</span>
                                        <span>Export Audio (Lossless)</span>
                                    </button>
                                </div>
                            </div>

                            <!-- Timeline + Tracks Wrapper (for global playhead) -->
                            <div class="daw-timeline-tracks-wrapper" id="dawTimelineTracksWrapper" style="position: relative;">
                                <!-- Global playhead line spanning ruler + all tracks -->
                                <div class="daw-global-playhead" id="dawGlobalPlayhead" style="left: 0; transform: translateX(0px);"></div>
                ...
                <!-- ================================================
                     2. MICROPHONE STUDIO COMPONENT
                     ================================================ -->
        <div class="component-container-v2" id="microphoneStudioComponent">
            <div class="component-header-v2">
                <div class="header-titles-v2">
                    <h3 class="component-title-v2">Microphone Studio</h3>
                    <p class="component-subtitle-v2">Record • Pitch Detection • Training • Autotune</p>
                </div>
                <div class="header-right-v2">
                    <button class="component-toggle-btn-v2" id="micComponentToggleBtn" onclick="toggleComponentV2('microphoneStudioComponent')">
                        <span class="toggle-icon-v2">+</span>
                        <span class="toggle-text-v2">Show</span>
                    </button>
                </div>
            </div>
            <div class="component-body-v2 hidden" id="microphoneStudioBody">
                <div class="mic-studio-transport">
                    <div class="mic-studio-status">
                        <span class="mic-studio-icon">🎙️</span>
                        <span class="mic-studio-status-text" id="micStudioStatusText">Click "Allow Microphone" to get started</span>
                    </div>
                    <div class="mic-studio-level">
                        <div class="mic-studio-level-bar" id="micStudioLevelBar"></div>
                    </div>
                    <div class="mic-studio-buttons">
                        <button class="mic-studio-btn mic-studio-connect" id="micStudioConnectBtn">
                            <span class="btn-icon">🎤</span>
                            <span class="btn-text">Allow Microphone</span>
                        </button>
                        <button class="mic-studio-btn mic-studio-rec" id="micStudioRecordBtn" disabled>
                            <span class="btn-icon">⏺</span>
                            <span class="btn-text">REC</span>
                        </button>
                        <button class="mic-studio-btn mic-studio-stop" id="micStudioStopBtn" disabled>
                            <span class="btn-icon">⏹</span>
                            <span class="btn-text">STOP</span>
                        </button>
                    </div>
                </div>
                <div class="mic-studio-recording-info" id="micStudioRecordingInfo" style="display: none;">
                    <div class="mic-studio-rec-indicator">
                        <span class="rec-dot"></span>
                        <span class="mic-studio-rec-time" id="micStudioRecTime">0:00</span>
                    </div>
                </div>
                <div class="mic-feature-tabs">
                    <button class="mic-feature-tab active" data-panel="pitchDetectorPanel">Pitch Detector</button>
                    <button class="mic-feature-tab" data-panel="trainingPanel">Training</button>
                    <!-- Harmonize tab removed -->
                    <button class="mic-feature-tab" data-panel="autotunePanel">Autotune</button>
                </div>
                <div class="mic-feature-panel" id="pitchDetectorPanel">
                    <div class="mic-feature-header">
                        <h4>Real-Time Pitch Detector</h4>
                        <button class="mic-feature-toggle" id="pitchDetectionToggle">Start</button>
                    </div>
                    <div class="pitch-detector-display hidden" id="pitchDetectorDisplay">
                        <div class="tuner-gauge">
                            <div class="tuner-scale">
                                <span class="tuner-mark flat">♭</span>
                                <span class="tuner-mark center">|</span>
                                <span class="tuner-mark sharp">♯</span>
                            </div>
                            <div class="tuner-needle" id="pitchNeedle"></div>
                        </div>
                        <div class="tuner-info">
                            <div class="tuner-note" id="pitchNoteDisplay">—</div>
                            <div class="tuner-cents" id="pitchCentsDisplay"></div>
                            <div class="tuner-freq" id="pitchFreqDisplay">— Hz</div>
                        </div>
                        <div class="pitch-history-container">
                            <canvas class="pitch-history-canvas" id="pitchHistoryCanvas"></canvas>
                        </div>
                    </div>
                </div>
                <div class="mic-feature-panel hidden" id="trainingPanel">
                    <div class="mic-feature-header">
                        <h4>Pitch Training</h4>
                        <button class="mic-feature-toggle" id="trainingToggle">Start</button>
                    </div>
                    <div class="training-display hidden" id="trainingDisplay">
                        <div class="training-target">
                            <span class="training-label">Sing this note:</span>
                            <div class="training-target-note" id="trainingTargetNote">—</div>
                        </div>
                        <div class="training-feedback" id="trainingFeedback">Press Start to begin</div>
                        <div class="training-stats">
                            <div class="training-stat">
                                <span class="stat-label">Score</span>
                                <span class="stat-value" id="trainingScoreDisplay">0 / 0</span>
                            </div>
                            <div class="training-stat">
                                <span class="stat-label">Accuracy</span>
                                <span class="stat-value" id="trainingAccuracy">—</span>
                            </div>
                        </div>
                        <div class="training-controls">
                            <button class="mic-action-btn" id="trainingNewNote">Skip Note</button>
                            <button class="mic-action-btn secondary" id="trainingReset">Reset Score</button>
                        </div>
                    </div>
                </div>
                <!-- Harmonization panel removed -->
                <div class="mic-feature-panel hidden" id="autotunePanel">
                    <div class="mic-feature-header">
                        <h4>Vocoder / Autotune</h4>
                        <button class="mic-feature-toggle" id="autotuneToggle">Start</button>
                    </div>
                    <div class="autotune-display hidden" id="autotuneDisplay">
                        <div class="autotune-controls-grid">
                            <div class="autotune-control">
                                <label>Key</label>
                                <select id="autotuneKeySelect" class="mic-select">
                            ...
                            <div class="autotune-control">
                                <label>Scale</label>
                                <select id="autotuneScaleSelect" class="mic-select">
                            ...
                            <div class="autotune-control">
                                <label>Correction Speed</label>
                                <input type="range" id="autotuneSpeedSlider" min="0" max="1" step="0.01" value="0.5" class="mic-slider">
                                <span id="autotuneSpeedDisplay">50%</span>
                            </div>
                        </div>
                        <div class="autotune-status" id="autotuneStatus">Autotune off</div>
                    </div>
                </div>
                <div class="mic-studio-recordings">
                    <h4 class="mic-recordings-title">Recordings</h4>
                    <div class="mic-studio-recordings-list" id="micStudioRecordingsList"></div>
                </div>
            </div>
        </div> <!-- End microphoneStudioComponent -->

                <!-- ================================================
                     3. VIRTUAL PIANO COMPONENT
                     ================================================ -->
        <div class="component-container-v2" id="virtualPianoComponent">
            <div class="component-header-v2">
                <div class="header-titles-v2">
                    <h3 class="component-title-v2">Virtual Piano</h3>
                    <p class="component-subtitle-v2">88-key piano • MIDI support • High-quality Salamander Grand</p>
                </div>
                <div class="header-right-v2">
                    ...
                    <div class="piano-controls-right">
                        <div class="instrument-selector-piano">
                            ...
                            <select class="piano-instrument-select" id="pianoInstrumentSelect" aria-label="Select piano instrument sound">
                                ...
                                <option value="bell-piano">Bell Piano</option>
                        ...
                        <div class="backtracks-player-row">
                            <div class="backtracks-select-wrapper">
                                <select class="backtracks-select" id="backTrackSelect" aria-label="Select a back track">
                                    ...
                                    <?php
                                    $bt_dir = get_stylesheet_directory() . '/assets/audio/backtracks/';
                                    $bt_names_opt = get_option('pianomode_vp_backtrack_names', array());
                                    if (is_dir($bt_dir)) {
                                        $bt_files = scandir($bt_dir);
                                        foreach ($bt_files as $bt_f) {
                                            $ext = strtolower(pathinfo($bt_f, PATHINFO_EXTENSION));
                                            if (in_array($ext, array('mp3', 'wav', 'ogg'))) {
                                                $display = isset($bt_names_opt[$bt_f]) ? $bt_names_opt[$bt_f] : ucwords(str_replace(array('_', '-', '.mp3', '.wav', '.ogg'), array(' ', ' ', '', '', ''), $bt_f));
                                                echo '<option value="' . esc_attr($bt_f) . '">' . esc_html($display) . '</option>' . "\n";
                                            }
                                        }
                                    }
                                    ?>
                            ...
                            <div class="backtracks-transport">
                                ...
                                <button class="backtracks-btn edit-btn" id="btEditBtn" title="Edit / Trim backtrack">
                                    <span class="btn-icon">✂️</span>
                                    <span>Edit</span>
                                </button>
                                <button class="backtracks-btn send-btn" id="btSendToMixBtn" title="Send to Recording Studio">
                                    <span class="btn-icon">📤</span>
                                    <span>Send to Rec Studio</span>
                                </button>
                            </div>
                            <!-- Backtrack Volume Control -->
                            <div class="backtracks-volume-control" id="btVolumeControl">
                                <label class="bt-vol-label" for="btVolumeSlider">Vol</label>
                                <input type="range" class="bt-volume-slider" id="btVolumeSlider" min="0" max="100" value="40" step="1" title="Backtrack Volume">
                                <span class="bt-vol-value" id="btVolumeValue">40%</span>
                            </div>
                        </div>
        ...
        <div class="component-container-v2" id="drumMachineComponent">
            <div class="component-header-v2">
                <div class="header-titles-v2">
                    ...
                    <p class="component-subtitle-v2">16-step sequencer • Live recording • 12 instruments</p>
                </div>
                <div class="header-right-v2">
                    ...
                    <div class="drum-recording-track">
                        ...
                        <div class="drum-rec-actions" style="display: none; gap: 8px; padding: 8px; justify-content: center; border-top: 1px solid rgba(215,191,129,0.2);">
                            ...
                            <button class="drum-transport-btn" onclick="virtualStudio.sendDrumRecordingToMix()" style="background: rgba(76,175,80,0.2); border-color: #4CAF50;">
                                <span style="color: #4CAF50;">📤 Send to Rec Studio</span>
                            </button>
                        ...
                        <div class="drum-track-editor" id="drumTrackEditor" style="display: none; padding: 12px; background: rgba(20,20,20,0.9); border-top: 1px solid rgba(215,191,129,0.3);">
                            ...
                            <div class="editor-controls" style="display: flex; gap: 20px; align-items: center; justify-content: center; padding-top: 8px;">
                                ...
                                <button onclick="virtualStudio.applyTrim()" style="background: rgba(33,150,243,0.2); border: 1px solid #2196F3; color: #2196F3; padding: 6px 14px; border-radius: 4px; cursor: pointer; font-size: 12px; font-weight: 600;">✓ Apply Cut</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Microphone Studio moved above Virtual Piano -->
