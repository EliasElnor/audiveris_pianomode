...
<div id="pm-home-root" class="pm-home-root" data-state="landing">
    ...
    <section id="pm-concert-hall" class="pm-concert-hall-section" style="background:#080810;">
        ...
        <div id="pm-header-overlay" class="pm-header-overlay visible pm-no-transition">
            ...
            <p class="pm-main-subtitle">
                360° piano resources for every level including tutorials, practice guides, sheet music, learning games &amp; buying guides for the Pianist.
            </p>
    ...
    <!-- ========================================
         SECTION 2: MODULE CARDS (Listen, Play & Explore)
         Start-journey design with random images
         ======================================== -->
    <section id="pm-explore-section" class="pm-modules-section">
        <div class="pm-modules-container">
            <!-- Listen -->
            <a href="<?php echo $listen_play_url; ?>" class="pm-module-card">
                <div class="pm-module-bg" style="background-image: url('<?php echo esc_url($listen_play_image); ?>');"></div>
                ...
                <div class="pm-module-content">
                    ...
                    <h3 class="pm-module-title">Listen</h3>
                    <p class="pm-module-subtitle">Sheet Music & Audio Library</p>
                    <p class="pm-module-desc">Explore our curated collection of downloadable sheet music with high-quality audio previews.</p>
            ...
            <!-- Play -->
            <a href="<?php echo $play_url; ?>" class="pm-module-card">
                <div class="pm-module-bg" style="background-image: url('<?php echo esc_url($play_image); ?>');"></div>
                <div class="pm-module-overlay"></div>
                <div class="pm-module-content">
                    <div class="pm-module-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                    ...
                    <h3 class="pm-module-title">Play</h3>
                    <p class="pm-module-subtitle">Interactive Music Games</p>
                    <p class="pm-module-desc">Challenge yourself with fun piano games designed to sharpen your ear, rhythm and reading skills.</p>
                    <span class="pm-module-btn">
                        Start Playing
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M5 12h14M12 5l7 7-7 7"/>
            ...
            <!-- Explore -->
            <a href="<?php echo $explore_url; ?>" class="pm-module-card">
                <div class="pm-module-bg" style="background-image: url('<?php echo esc_url($explore_image); ?>');"></div>
                <div class="pm-module-overlay"></div>
                <div class="pm-module-content">
                    <div class="pm-module-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                    ...
                    <h3 class="pm-module-title">Explore</h3>
                    <p class="pm-module-subtitle">Artists, Stories & Culture</p>
                    <p class="pm-module-desc">Dive into the world of piano: legendary artists, gear reviews, and iconic compositions.</p>
                    <span class="pm-module-btn">
                        Start Exploring
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M5 12h14M12 5l7 7-7 7"/>
